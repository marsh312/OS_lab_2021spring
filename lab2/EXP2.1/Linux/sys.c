...
SYSCALL_DEFINE4(ps_info, int __user *, num, int __user *, pid, unsigned long __user *, time, char __user **, command){
         struct task_struct* task;
         int counter = 0;
         ...
         for_each_process(task){
               ...
               copy_to_user( time+counter, &(task->stime), sizeof(unsigned long));
